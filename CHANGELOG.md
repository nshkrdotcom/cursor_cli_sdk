...
[0.4.0]: https://github.com/nshkrdotcom/cursor_cli_sdk/compare/v0.3.0...v0.4.0
...
- Require `cli_subprocess_core ~> 0.8.0` for compatibility with the current SDK and Agent Session Manager release train.
